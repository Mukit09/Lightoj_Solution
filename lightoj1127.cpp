...
int dx[]={0,0,1,-1};
int dy[]={1,-1,0,0};
int j,l,n,cs=1,l1,l2,sm,cnt,fg,in[35];
i64 a1[si],a2[si],m;
...
void rec1(int ind,i64 tot)
{
    ...
    int i;
    rec1(ind+1,tot);
    rec1(ind+1,tot+in[ind]);
}

void rec2(int ind,i64 tot)
{
    if(ind==n)
    {
        a2[l2++]=tot;
